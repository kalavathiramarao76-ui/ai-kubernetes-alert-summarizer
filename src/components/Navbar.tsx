...
const navItems = [
  ...
  { href: "/app/favorites", label: "Favorites", icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z", badge: "favorites" },
  ...
  { href: "/app/settings/roles", label: "Roles", icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z", badge: null },
];
...
function useFavoriteCount(): number {
  const [count, setCount] = useState(0);
  useEffect(() => {
    const refresh = () => {
      try {
        const data = JSON.parse(localStorage.getItem("k8s-favorites") || "[]");
...
export default function Navbar() {
  ...
  const getBadgeValue = (badge: string | null): number | null => {
    ...
    if (badge === "favorites") return favoriteCount > 0 ? favoriteCount : null;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-1">
            ...
            {/* Team Presence */}
            <div className="hidden md:flex items-center mr-2 ml-2">
              <CollabPresence />
            </div>
